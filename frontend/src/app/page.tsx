        ...
        {/* Navigation Bar */}
          <nav className="flex justify-between items-center pb-2">
            <a 
              ...
              className="text-sm text-slate-400 hover:text-slate-200 flex items-center gap-2 transition-colors font-semibold"
            >
            ...
            <a 
              href="https://github.com/ramnjit/enterprise-triage-engine" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-sm bg-purple-600 hover:bg-purple-500 text-white px-4 py-2.5 rounded-lg flex items-center gap-2 transition-colors font-bold shadow-sm border border-purple-500/20"
            >
